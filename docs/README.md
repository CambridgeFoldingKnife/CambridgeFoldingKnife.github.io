...
footer:
  record: MIT License
  recordLink: 'https://github.com/CambridgeFoldingKnife/CambridgeFoldingKnife-Blog'
  cyberSecurityRecord: 剑桥折刀的博客
  cyberSecurityLink: 'https://github.com/CambridgeFoldingKnife'
  startYear: 2025
---
...
<div class="profile-name">剑桥折刀</div>
<button class="close-btn" id="closeBtn">✕</button>
</div>

<!-- 社交链接 -->
<div class="profile-social">
<a href="mailto:3144253125@qq.com" class="social-link" title="发送邮件">
<span class="social-icon">📧</span>
<span class="social-text">邮箱</span>
</a>
<a href="https://github.com/CambridgeFoldingKnife" target="_blank" class="social-link" title="访问 GitHub">
<span class="social-icon">🐙</span>
