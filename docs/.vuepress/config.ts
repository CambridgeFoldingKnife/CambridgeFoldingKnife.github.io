...
export default defineUserConfig({
    ...
    // 本地开发: 使用根路径 /
    // Vercel: 使用根路径 /
    // GitHub Pages: 使用 /CambridgeFoldingKnife.github.io/ (与GitHub仓库名称保持一致)
    base: process.env.VERCEL || process.env.NODE_ENV === 'development' ? '/' : '/CambridgeFoldingKnife.github.io/',
    ...
    locales: {
        ...
        '/en/': {
            lang: 'en-US',
            title: "Cambridge Folding Knife's Blog",
